...
def main():
    ...
    for name in [
        "run_qwen3_5_2b_16case_standard_v0_1.py",
        "audit_qwen3_5_2b_16case_standard_v0_1.py",
    ]:
        shutil.copy2(here/"scripts"/name, project/"scripts"/name)

    shutil.copy2(
        here/"tests"/"preflight_qwen3_5_2b_16case_standard_v0_1.py",
        project/"scripts"/"preflight_qwen3_5_2b_16case_standard_v0_1.py"
    )

    for name in [
        "Structured_Document_Analysis_Layer_v1.0_FREEZE.json",
        "Context_Budget_Manager_v0.2_Manifest.json",
        "Qwen3_5_2B_16Case_Standard_Evaluation_v0.1_Manifest.json",
    ]:
        shutil.copy2(here/"data"/name, project/"data"/name)

    print("Qwen3.5-2B 16-case Standard evaluation files copied into:", project)
