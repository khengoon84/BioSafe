...
def main():
    ...
    shutil.copy2(
        here/"scripts"/"run_stage7_3_5_evidence_binding_final_v0_1.py",
        project/"scripts"/"run_stage7_3_5_evidence_binding_final_v0_1.py",
    )
    shutil.copy2(
        here/"tests"/"preflight_stage7_3_5_evidence_binding_final_v0_1.py",
        project/"scripts"/"preflight_stage7_3_5_evidence_binding_final_v0_1.py",
    )

    print("Stage 7.3.5 files copied into:", project)
