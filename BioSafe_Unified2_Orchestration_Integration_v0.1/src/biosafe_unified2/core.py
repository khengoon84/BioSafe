...
class UnifiedOrchestrator:
    ...
    def prepare(self,query,session_id=None,attachments=None):
        ...
        return {"session_id":s.session_id,"intent":intent,"workflow":workflow,"query":query,"original_query":query,"attachments":attachments,"case_state":dict(s.case.facts),"missing_information":missing,"resolved_reference":previous if intent=="follow_up" else None,"requires_retrieval":intent in {"educational_answer","regulatory_assessment","document_review","form_e_assist"},"constitution_version":"BioSafe Behavioral Constitution v1.0"}
