...
MODEL_CONFIGS = {
    "qwen3:0.6b": {"temperature": 0.0, "num_predict": 900, "think": None},
    "qwen3:1.7b": {"temperature": 0.0, "num_predict": 900, "think": None},
}
...
def main():
    ...
    ap.add_argument("--output-dir", default=str(PROJECT_ROOT / "output/context_aware_document_benchmark_v0_2"))
    args = ap.parse_args()
    ...
    master = {
        "suite": "BioSafe_Context_Aware_Document_Benchmark_v0.2",
        "cases": len(cases),
        "models": {},
