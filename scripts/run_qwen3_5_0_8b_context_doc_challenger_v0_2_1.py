...
def main():
    ...
    ap.add_argument("--data", default=str(PROJECT_ROOT / "data/BioSafe_Context_Aware_Document_Benchmark_v0.2.1.jsonl"))
    ...
    master = {
        "suite": "BioSafe_Qwen3.5_0.8B_Context_Aware_Document_Challenger_v0.2.1",
        "cases": len(cases),
        "models": {},
