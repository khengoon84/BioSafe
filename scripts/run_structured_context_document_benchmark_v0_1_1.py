...
def main():
    ...
    ap.add_argument("--output-dir", default=str(PROJECT_ROOT/"output/structured_doc_qwen3_5_0_8b_v0_1_1"))
    args = ap.parse_args()
    ...
    master = {
        "suite": "BioSafe_Structured_Document_Benchmark_Integration_v0.1.1",
        "cases": len(cases),
