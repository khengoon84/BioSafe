...
def main():
    ...
    ap.add_argument("--output-dir", default=str(PROJECT_ROOT/"output/context_budget_manager_v0_2_qwen3_5_0_8b"))
    args = ap.parse_args()
    ...
    master = {
        "suite": "BioSafe_Context_Budget_Manager_v0.2 + Deterministic_Response_Assembler_v0.1",
        "cases": len(cases),
                ...
                if deterministic is not None:
                    ...
                    if compact0 is None and packet.get("contradictions"):
                        ...
                        parsed0 = assemble_biosafe_response(
                            ...
                            max_missing=profile.max_missing_findings,
                            max_recommendations=profile.max_recommendations,
                            max_evidence=profile.max_rag_claims,
                            max_limitations=profile.max_limitations,
                        )
                        valid = True
