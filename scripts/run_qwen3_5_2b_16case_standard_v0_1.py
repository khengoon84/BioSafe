...
def main():
    ...
    ap.add_argument("--models", nargs="+", default=["qwen3.5:2b"])
    ap.add_argument(
        "--regression-only",
        action="store_true",
    ...
    ap.add_argument("--output-dir", default=str(PROJECT_ROOT/"output/qwen3_5_2b_16case_standard_v0_1"))
    args = ap.parse_args()
    ...
    master = {
        "suite": "BioSafe_Qwen3.5_2B_16Case_Standard_Evaluation_v0.1",
        "cases": len(cases),
