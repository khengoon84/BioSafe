...
MODELS = ["qwen3.5:0.8b"]
MODEL_CONFIGS = {
    "qwen3.5:0.8b": {"temperature": 0.0, "num_predict": 900, "think": False},
}
...
def main():
    ...
    ap.add_argument(
        "--regression-only",
        action="store_true",
        help="Run only PROP-002, FORM-002, SOP-002, PROP-004 and FORM-004."
    )
    ...
    ap.add_argument("--output-dir", default=str(PROJECT_ROOT/"output/stage7_3_2_qwen3_5_0_8b_v0_1"))
    args = ap.parse_args()
    ...
    if args.regression_only:
        regression_ids = {"PROP-002", "FORM-002", "SOP-002", "PROP-004", "FORM-004"}
    ...
    master = {
        "suite": "BioSafe_Stage7_3_2_Document_Stabilization_v0.1",
        "cases": len(cases),
        "frozen_benchmark": "BioSafe_Context_Aware_Document_Benchmark_v0.2",
        "structured_layer": "BioSafe Structured Document Analysis Layer v0.1",
        "pipeline": {
