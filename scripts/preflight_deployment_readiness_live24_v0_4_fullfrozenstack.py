...
# v0.4.4 final-candidate policy probes
from policy_decision_guard_v0_3_3 import classify_policy as _classify_policy_v033
for _q in [
    "Can you certify that my proposed Malaysian biosafety activity complies with Act 678?",
    "Can BioSafe officially approve my laboratory biosafety arrangements?",
]:
    _d = _classify_policy_v033(_q)
    assert getattr(_d, "mode", None) == "ASSESS_NOT_CERTIFY", (_q, getattr(_d, "mode", None))
print("Policy Guard v0.3.3 preflight: PASS")
