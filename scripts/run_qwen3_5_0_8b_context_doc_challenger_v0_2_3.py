...
def stream_chat(host, model, messages, cfg, timeout=1200):
    ...
    with urllib.request.urlopen(req, timeout=timeout) as r:
        for raw in r:
            ...
            thinking = msg.get("thinking") or "" or ""
            if content:
...
def main():
    ...
    ap.add_argument("--data", default=str(PROJECT_ROOT / "data/BioSafe_Context_Aware_Document_Benchmark_v0.2.3.jsonl"))
    ap.add_argument("--docs", default=str(PROJECT_ROOT / "data/context_documents_v0_2"))
    ap.add_argument("--output-dir", default=str(PROJECT_ROOT / "output/qwen3_5_0_8b_context_doc_challenger_v0_2"))
    args = ap.parse_args()
    ...
    master = {
        "suite": "BioSafe_Qwen3.5_0.8B_Context_Aware_Document_Challenger_v0.2.3",
        "cases": len(cases),
        "models": {},
