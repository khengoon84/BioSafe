...
from biosafe_pipeline_v0_3 import BioSafePipelineV03
from output_validator_v0_2 import validate_output, build_retry_instruction
from boundary_validator_v0_3 import validate_boundaries
...
def main():
    ...
    pipe = BioSafePipelineV03(ROOT, 3)
    ...
    out = ROOT / "output" / f"boundary_v0_3_{safe_model}.jsonl"
                ...
                if not args.no_retry and first == "RETRY":
                    ...
                    retry_messages = list(messages) + [
                        ...
                        {"role":"user","content":
                            ...
                            + "\nPreserve the policy_decision constraints exactly."
                        }
                    ]
