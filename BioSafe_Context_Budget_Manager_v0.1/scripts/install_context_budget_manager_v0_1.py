...
def main():
    ...
    shutil.copy2(here/"scripts"/"run_context_budget_manager_v0_1.py",
                 project/"scripts"/"run_context_budget_manager_v0_1.py")
    shutil.copy2(here/"tests"/"preflight_context_budget_manager_v0_1.py",
                 project/"scripts"/"preflight_context_budget_manager_v0_1.py")
    ...
    shutil.copy2(here/"data"/"Context_Budget_Manager_v0.1_Manifest.json",
                 project/"data"/"Context_Budget_Manager_v0.1_Manifest.json")

    print("Context Budget Manager v0.1 files copied into:", project)
    print("Structured Document Analysis Layer v1.0 architecture remains frozen.")
    print("KB/RAG/router/scope/policy files were not modified.")
