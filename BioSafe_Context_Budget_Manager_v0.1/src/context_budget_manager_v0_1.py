...
def response_contract(profile: ModelBudgetProfile) -> str:
    return "\n".join([
        ...
        "Conclusion: maximum 90 words.",
        f"Evidence: maximum {profile.max_rag_claims + min(profile.max_document_evidence, 3)} items.",
        ...
        "Always complete the safety object.",
