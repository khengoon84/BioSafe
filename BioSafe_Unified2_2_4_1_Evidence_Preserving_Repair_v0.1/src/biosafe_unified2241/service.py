...
class Unified2241Service:
    ...
    def infer(self,prep,documents=None):
        ...
        # Critical change: semantic verification/repair receives the SAME scoped
        # authoritative evidence captured before generation/assembly.
