...
def ask(q):
 req=urllib.request.Request(BASE+"/api/ask",data=json.dumps({"query":q}).encode(),method="POST",
...
print("These are hard smoke assertions only; human semantic/provenance review remains required.")
