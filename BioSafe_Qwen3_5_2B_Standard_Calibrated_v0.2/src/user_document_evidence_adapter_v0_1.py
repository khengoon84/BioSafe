...
def build_user_document_evidence(packet: dict[str, Any], max_items: int = 6) -> list[dict[str, Any]]:
    ...
    for doc in packet.get("structured_facts", []) or []:
        ...
        for field in (
            "objectives", "transport", "waste", "emergency_response",
            "facility", "containment", "host_organism", "construct_identity",
            "culture_scale", "project_title", "principal_investigator",
            "institution", "project_duration", "proposed_start"
        ):
