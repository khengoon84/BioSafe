...
MODEL_CONFIGS = {
    ...
    "qwen3.5:2b": {"temperature": 0.0, "num_predict": 420, "think": False},
}
...
def main():
    ...
    ap.add_argument("--output-dir", default=str(PROJECT_ROOT/"output/qwen3_5_2b_standard_calibrated_v0_2"))
    args = ap.parse_args()
    ...
    master = {
        "suite": "BioSafe_Qwen3.5_2B_Standard_Calibrated_v0.2",
        "cases": len(cases),
        ...
        with outfile.open("w", encoding="utf-8") as f:
            for idx, case in enumerate(cases, 1):
                ...
                rec = {
                    ...
                    "calibration": {
                        "profile": "Qwen3.5-2B Standard-Calibrated v0.2",
                        ...
                        "max_limitations": 1,
                        "comparison_target": "Qwen3.5-0.8B Lite compact envelope"
                    },
                }
