...
def filter_document_review_evidence(
    ...
    # Zero regulatory evidence is preferable to reintroducing a known
    # domain-inappropriate claim. The user document and structured findings
    # remain available to the model; RAG evidence may legitimately be empty.
    fallback_used = False
