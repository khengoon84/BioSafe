...
- **C2 WHO LBM4 PPE claim review (11 September 2026):** the project owner completed guarded batch `KB-WHO-LBM4-PPE-REVIEW-01` for CLM-042 and CLM-043 against the immutable WHO personal-protective-equipment monograph and exact native candidate text on PDF pages 29, 33, and 35. Both claims are `SUPPORTED_AFTER_ATOMIC_SPLIT`. The retained propositions cover core requirements as foundational and integral combined controls; GMPP as the most important laboratory-facility requirement and a code of practice for activities with biological agents; the listed PPE core requirements; the core-versus-heightened-control distinction for respiratory protection; risk-assessment-directed additional PPE and control selection; wearer-only protection and possible need for other measures; and selection based on risk-assessment results with trained use. Excluded graphical PDF page 42 was not used. The categorical historical phrase that PPE is not a complete safety determination is preserved as a BioSafe boundary rather than attributed WHO wording. WHO material remains Tier 3 international technical guidance rather than Malaysian law or regulatory proof, and no project-specific PPE, respiratory-protection, safety, containment, approval, or compliance determination is made. The canonical map now contains 44 completed and 1 pending review; 31 claims are in the additive offline curated candidate set. Map, claim-packet, curated-candidate, and review-aid SHA-256 values are `47fc793a8f8fa4d5f05c8dcb8ac14793bb23b563a81eceffe18901f9ef099b42`, `9e73fa98d278e6cafe0ce68c59aabcc8cf55518824eaac3634a9d43e7faca264`, `535973aa3d3ce93c54854073f51eac677e82c9647ae18af7a1be9f26fe868f77`, and `4c08049098a7c3f1f4d0f4b65ca2e5d8607f36b7931f63ba624454eec78092aa`. Claim use remains `REVIEW_REQUIRED_BEFORE_CLAIM_USE` and live activation remains `PROHIBITED_PENDING_PHASE_C_GATES`; active retrieval, inference, routing, model configuration, and frozen modules remain unchanged.

- **C2 WHO 2024 laboratory-biosecurity claim review (11 September 2026):** the project owner completed guarded batch `KB-WHO-BIOSEC-REVIEW-01` for CLM-034 against the immutable WHO Laboratory biosecurity guidance and exact native candidate text on PDF pages 21 and 23. CLM-034 is `SUPPORTED_AFTER_ATOMIC_SPLIT`. The retained propositions cover application of a risk- and evidence-based approach to laboratory biosecurity; application to high-consequence research and other activities involving biosecurity-relevant material, technology, or information; tools and best practices at laboratory, institution, and national-regulatory levels plus lifecycle examples including collection, transport, processing, storage, and possible destruction; and the described two-tier IBC/national-regulatory-body model for review and oversight of high-consequence work. The historical “governance” wording is narrowed to the source’s stated structures, and “secure handling” is not attributed to the cited passages. WHO material remains Tier 3 international technical guidance rather than Malaysian law or regulatory proof. The review makes no project-specific high-consequence classification, governance, handling, transport, storage, control, approval, compliance, or Malaysian-regulator determination. All 45 required claim reviews are now complete and 32 claims are in the additive offline curated candidate set. Map, claim-packet, curated-candidate, and review-aid SHA-256 values are `928473f4c6e3fdd47721afc59107c15bd832d310a435f12dbd8fa5a53a8c7bb9`, `956d6d01f03f3ad34e69aa28dfe2ff2b8f58f73c8d86254f90c581aee7df5144`, `b48da48c1234ec3f9a7580b1fad9b6893e3d69aac1c7df4702b4d224a85b3b8e`, and `0eb907b5b31caa2c87048f9c4a5a5864440fecc85c7611ecf9ed2828403d118a`. Claim use remains `REVIEW_REQUIRED_BEFORE_CLAIM_USE` and live activation remains `PROHIBITED_PENDING_PHASE_C_GATES`; review completion does not authorize either, and active retrieval, inference, routing, model configuration, and frozen modules remain unchanged.
