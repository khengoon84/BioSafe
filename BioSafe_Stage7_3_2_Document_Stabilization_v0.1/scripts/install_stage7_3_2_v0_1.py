...
def main():
    ...
    shutil.copy2(
        here/"scripts"/"run_stage7_3_2_document_stabilization_v0_1.py",
        project/"scripts"/"run_stage7_3_2_document_stabilization_v0_1.py",
    )
    shutil.copy2(
        here/"tests"/"preflight_stage7_3_2_document_stabilization_v0_1.py",
        project/"scripts"/"preflight_stage7_3_2_document_stabilization_v0_1.py",
    )
    print("Stage 7.3.2 files copied into:", project)
