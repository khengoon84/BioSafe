...
def main():
    ...
    shutil.copy2(
        here/"scripts"/"run_stage7_3_4_prop002_semantic_guard_v0_1.py",
        project/"scripts"/"run_stage7_3_4_prop002_semantic_guard_v0_1.py",
    )
    shutil.copy2(
        here/"tests"/"preflight_stage7_3_4_prop002_semantic_guard_v0_1.py",
        project/"scripts"/"preflight_stage7_3_4_prop002_semantic_guard_v0_1.py",
    )

    print("Stage 7.3.4 files copied into:", project)
