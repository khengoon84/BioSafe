...
def main():
    ...
    ap.add_argument("--output-dir", default=str(PROJECT_ROOT/"output/stage7_3_qwen3_5_0_8b_v0_1"))
    args = ap.parse_args()
    ...
    master = {
        "suite": "BioSafe_Stage7_3_Document_Stabilization_v0.1",
        "cases": len(cases),
        ...
        with outfile.open("w", encoding="utf-8") as f:
            for idx, case in enumerate(cases, 1):
                ...
                if deterministic is not None:
                    ...
                    contradiction_fallback_used = False
                    if (
                        (not valid or gen.get("done_reason") == "length")
