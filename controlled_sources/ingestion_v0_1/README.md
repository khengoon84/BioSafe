...
Generate source-coherent, navigation-only markdown briefs for the 21 pending claims with:
...
`review/INDEX.md` links six briefs grouped by controlled document. The generator verifies
