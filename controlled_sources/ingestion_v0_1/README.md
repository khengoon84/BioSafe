...
The legal draft map and artifact SHA-256 values are `210e2eb6131d7a98dab8d53ac634b18ba37cb7d7d67e66060d0b1e727fc791af` and `8e7ace043a83c3faea525fe935a6e31e8daa4fd0c1f2019cc293e7040e358e55`. The nine legal-claim reviews remain completed with disposition `CURRENTNESS_UNRESOLVED` (no support spans; excluded from curation). Subsequent Form E, contained-use guidance, Malaysian GMM risk-assessment guidance, Malaysian transport-guideline, IBC-governance, WHO LBM4 risk-assessment, WHO LBM4 core-manual, and WHO LBM4 PPE reviews brought the current totals to 44 completed, one pending, and 31 curated; live activation remains prohibited.
