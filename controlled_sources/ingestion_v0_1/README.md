...
Generate source-coherent, navigation-only markdown briefs for the 18 pending claims with:
...
`review/INDEX.md` links five briefs grouped by controlled document. The generator verifies
