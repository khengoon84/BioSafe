...
Generate source-coherent, navigation-only markdown briefs for the 15 pending claims with:
...
`review/INDEX.md` links four briefs grouped by controlled document. The generator verifies
