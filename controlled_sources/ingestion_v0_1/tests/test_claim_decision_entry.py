...
SYNTHETIC_PENDING_CLAIM_ID = "CLM-026"
...
class ClaimDecisionEntryTests(unittest.TestCase):
    ...
    def test_applies_exactly_one_pending_claim_and_reports_curation(self):
        ...
        self.assertEqual(report["total_completed_review_count"], 25)
        self.assertEqual(report["total_pending_review_count"], 20)
    ...
    def test_public_cli_writes_exact_snapshot_map_and_report(self):
        ...
        with tempfile.TemporaryDirectory() as directory:
            ...
            self.assertIn("changed=1 completed=25 curated=13 dry_run=False", process.stdout)
